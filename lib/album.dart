...
class _AlbumPageState extends State<AlbumPage> {
  ...
  void initState() {
    ...
    if(user!=null)
      actions = [FotoButton(hotelid: widget.hotelid, catid: widget.catid), LoginButton()];
    else
      actions = [LoginButton()];
    ...
    return Scaffold(
        ...
        body: Container(
            ...
            child: StreamBuilder<QuerySnapshot>(
                stream: fireService.getFotosFromCat(widget.hotelid, widget.catid),
                    ...
                    if (!event.data.empty) {
                      ...
                      return PageView.builder(
                          ...
                          itemBuilder: (context, index){
                            return imageSlider(index, event.data.docs[index].data()['url'].toString());
                      });
                    } else {
