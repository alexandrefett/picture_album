        ...
        children: <Widget>[
          ...
          Container(
              ...
              child: IconButton(
                  ...
                  onPressed:  () => fireService.deleteCat(widget.hotelid, cat.id)
              )
          )
              : Container(),
          FlatButton(
              ...
              onPressed:  () async => Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => AlbumPage(hotelid: widget.hotelid, catid: cat.id,))
              ),
              child:Column(
                ...
                children: <Widget>[
                  ClipRRect(
                      ...
                      child:Image.network(
                        cat.imageurl,fit: BoxFit.fitHeight,
                      )
                  ),
                  ...
                  if(event.data != null) {
                    if (!event.data.empty) {
                      ...
                      return Wrap(
                                ...
                                spacing: 20,
                                children: event.data.docs.map((data) => catItem(Categoria.fromJson(data.data()))).toList());
                    } else {
